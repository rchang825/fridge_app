...
class MealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meal" do
    assert_difference("Meal.count") do
      post meals_url, params: { meal: { name: @meal.name, notes: @meal.notes, user_id: @meal.user_id } }
    end
  ...
  test "should update meal" do
    patch meal_url(@meal), params: { meal: { name: @meal.name, notes: @meal.notes, user_id: @meal.user_id } }
